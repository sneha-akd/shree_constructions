  ...
  },
  {
    icon: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-heart-handshake w-5 h-5"
        aria-hidden="true"
      >
...
const expertises = [
  ...
  "All Types of Civil Construction Works",
];
...
const focus_svg = (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="lucide lucide-focus-icon lucide-focus"
  >
    <circle cx="12" cy="12" r="3" />
...
function About() {
  return (
    <section id="about">
      ...
      <p>
        With 26+ years of experience & Commitment to excellence,We turn ideas
        into reality and build a better future.
      </p>
      ...
      <div className="info-extra">
        <div className="info-card">
          <div className="info-content">
            <h2>
              Hands-on Civil & Infrastructure Engineering Across Pan India
            </h2>

            <p>
              Although <b>Shree Construction Engineers & Contractor</b> was
              established in 2025 as a proprietorship firm by{" "}
              <b>Aditya Raut</b>, our core leadership and engineering team
              bring over{" "}
              <span className="orange-text">26+ years of hands-on experience</span>{" "}
              in civil construction, infrastructure, industrial PEB sheds, and
              commercial building development. We deliver turnkey construction
              solutions with complete transparency, strict engineering
              compliance, and on-time project execution.
            </p>
          </div>
        ...
        <div className="extra-boxes">
          <div className="extra-box flex">
            <div className="svg">{focus_svg}</div>
          ...
          <div className="extra-box flex">
            <div className="svg">{eye_svg}</div>

            <div>
              <h3>OUR VISION</h3>
              <p>
                To handle bigger projects with excellence and become
              </p>
          ...
          <div className="extra-box flex">
            <div className="svg">{location_svg}</div>
      ...
      <div className="core-values-container">
        {core_values.map((value, index) => {
          return (
            <div className="core-value-box" key={index}>
