...
function Machinery() {
  return (
    <section id="machinery">
      ...
      <div>
        <p className="quote">
          Equipped with modern machinery and reliable resources to execute
          industrial, commercial and infrastructure projects efficiently.
        </p>
      </div>
      ...
      <div className="generic-grid generic-grid-4">
        ...
        {machines.map((machine, index) => {
          return (
            <div
              className="grid-item no-border machinery-item"
              key={index}
            >
